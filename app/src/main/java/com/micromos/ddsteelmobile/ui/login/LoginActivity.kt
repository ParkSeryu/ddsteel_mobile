...
import com.micromos.ddsteelmobile.UpdateActivity
import com.micromos.ddsteelmobile.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LoginViewModel =
            ViewModelProvider(this).get(com.micromos.ddsteelmobile.ui.login.LoginViewModel::class.java)
